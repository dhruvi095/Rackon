    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold mb-4 leading-snug">
...
=======
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <button
                ...
                className="px-6 py-2 rounded-lg font-medium transition border bg-white text-gray-700 hover:bg-green-100"
              >
>>>>>>> 379d2b245569f5033ee3104ec82caea0e43911b1
                I’m a Brand
              </button>
            </div>
          ) : (
<<<<<<< HEAD
            <div className="flex flex-col sm:flex-row justify-center gap-3 w-full max-w-3xl mx-auto">
              ...
              />
              <select className="p-2 rounded-lg border border-white bg-transparent text-white w-full sm:w-auto">
