                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <label
                                className={`cursor-pointer border rounded-lg p-4 text-center ${paymentMethod === "credit"
                            ...
                            <label
                                className={`cursor-pointer border rounded-lg p-4 text-center ${paymentMethod === "upi"
                                        ? "border-green-500 bg-green-50"
                                        : "border-gray-300"
                                    }`}
                            >
                            ...
                            <label
                                className={`cursor-pointer border rounded-lg p-4 text-center ${paymentMethod === "netbanking"
                                        ? "border-green-500 bg-green-50"
                                        : "border-gray-300"
                                    }`}
                            >
